...
setup(
    ...
    packages=['venv.Lib.site-packages.PIL', 'venv.Lib.site-packages.pip', 'venv.Lib.site-packages.pip._vendor',
              ...
              'venv.Lib.site-packages.cffi', 'venv.Lib.site-packages.idna', 'venv.Lib.site-packages.pytz',
              'venv.Lib.site-packages.click', 'venv.Lib.site-packages.django', 'venv.Lib.site-packages.django.db',
              ...
              'venv.Lib.site-packages.django.templatetags', 'venv.Lib.site-packages.google.protobuf',
              ...
              'venv.Lib.site-packages.google.protobuf.internal.import_test_package', 'venv.Lib.site-packages.captcha',
              'venv.Lib.site-packages.captcha.conf', 'venv.Lib.site-packages.captcha.tests',
              'venv.Lib.site-packages.captcha.management', 'venv.Lib.site-packages.captcha.management.commands',
              'venv.Lib.site-packages.captcha.migrations', 'venv.Lib.site-packages.pymysql',
              'venv.Lib.site-packages.pymysql.constants', 'venv.Lib.site-packages.pycparser',
              'venv.Lib.site-packages.pycparser.ply', 'venv.Lib.site-packages.asn1crypto',
              'venv.Lib.site-packages.asn1crypto._perf', 'venv.Lib.site-packages.marshmallow',
              ...
              'venv.Lib.site-packages.ranged_response',
              'venv.Lib.site-packages.django_simple_captcha-0.5.9-py3.7.egg.captcha',
              'venv.Lib.site-packages.django_simple_captcha-0.5.9-py3.7.egg.captcha.conf',
              'venv.Lib.site-packages.django_simple_captcha-0.5.9-py3.7.egg.captcha.tests',
              'venv.Lib.site-packages.django_simple_captcha-0.5.9-py3.7.egg.captcha.management',
              'venv.Lib.site-packages.django_simple_captcha-0.5.9-py3.7.egg.captcha.management.commands',
              'venv.Lib.site-packages.django_simple_captcha-0.5.9-py3.7.egg.captcha.migrations', 'login',
              'login.migrations', 'captcha.build.lib.captcha', 'captcha.build.lib.captcha.conf',
              'captcha.build.lib.captcha.tests', 'captcha.build.lib.captcha.management',
              'captcha.build.lib.captcha.management.commands', 'captcha.build.lib.captcha.migrations',
              'captcha.captcha', 'captcha.captcha.conf', 'captcha.captcha.tests', 'captcha.captcha.management',
              'captcha.captcha.management.commands', 'captcha.captcha.migrations', 'captcha.testproject', 'WebSite'],
    url='',
    license='',
    author='WangJJ',
    author_email='',
